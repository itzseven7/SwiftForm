...
extension PickerViewFormItemContainer where Self: TextFieldFormItemContainerResponderAdapter {
  
  public var pickerViewFormItemWithTextField: TextFieldResponderAdapter? {
