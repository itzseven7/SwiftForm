...
extension DatePickerFormItemContainer where Self: TextFieldFormItemContainerResponderAdapter {
  
  public var datePickerFormItemWithTextField: TextFieldResponderAdapter? {
    return formItem as? TextFieldResponderAdapter
  }
